...
for (par_ind, paragraph) in par.items():
	...
	if len(graphs) < 10000:
		pickle.dump(edge_types, open("edge_types2sentnocoref.pcl", "wb"))
		pickle.dump(graphs, open("graphs2sentnocoref.pcl", "wb"))
	else:
		#pickle.dump(edge_types[10000:20000], open("edge_types2sent2.pcl", "wb"))
		pickle.dump(graphs[10000:20000], open("graphs2sent2nocoref.pcl", "wb"))